...
class UniversalWeekday(FunctionElement):  # type: ignore
...
def compile_universal_weekday_postgres(element, compiler, **kw) -> str:  # type: ignore
...
def compile_universal_weekday_mysql(element, compiler, **kw) -> str:  # type: ignore
...
def compile_universal_weekday_sqlite(element, compiler, **kw) -> str:  # type: ignore
...
def compile_universal_weekday_default(element, compiler, **kw) -> str:  # type: ignore
